...
<form id="form2" name="form2" method="post" action="">
  ...
  <table border="1">
    ...
    <?php $total=0; do { ?>
      <tr bgcolor="#FFFF99">
        ...
        <td><?php echo $row_Recordset1['total_fact']; ?></td>
      </tr>
  ...
  <table width="179" border="1" cellspacing="1">
    ...
    <tr bgcolor="#996600">
      <td><span class="Estilo22"><?PHP echo "$".$total ?></span></td>
    </tr>
  </table>
  
  <p>&nbsp;</p>
</form>
<form id="form3" name="form3" method="get" action="cuentasclientes.php?$Nit">
  <label></label>
  <p>NIT  A DESCONTAR FACTURA </p>
  <label>
  <input name="Nit" type="text" id="Nit" value="<?php echo "".$Nit; ?>" readonly="readonly" />
  </label>
  <label>
...
<form id="form5" name="form5" method="post" action="">
  <table border="1" cellpadding="1" cellspacing="1">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_Recordset4['SUM( abonos.abono )']; ?></td>
      </tr>
    ...
    <form method="post" name="form4" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="text" name="Nit" value="<?php echo "".$Nit; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
