...
mysql_select_db($database_conn, $conn);
 $query_Recordset1 = "SELECT entrada_caja.fecha_entrada, entrada_caja.valor_entrada,   cierre_caja.devoluciones, cierre_caja.fecha_cierre,  cierre_caja.total_cierre,pos.id_caja,pos.nomb_caja FROM cierre_caja   INNER JOIN entrada_caja ON (cierre_caja.id_entracaja = entrada_caja.id_entracaja)   INNER JOIN usuarios ON (cierre_caja.id_usuarios = usuarios.id_usuarios)   INNER JOIN pos ON (cierre_caja.id_caja = pos.id_caja) WHERE usuarios.id_usuarios=$cajero AND    entrada_caja.fecha_entrada between '$fecha 00:00:00' and '$fecha 23:59:00' ORDER BY entrada_caja.fecha_entrada desc";
