...
<form id="form2" name="form2" method="post" action="">
  <p>&nbsp;</p>
  <p>Estimado Usuario al dar click en el boton cerrar vigencia, borrará los articulos vendidos en cantidades de productos que forman parte de las familias, dejant¡do sus ventas en cero e niciar nueva contabilidad.</p>
  <p>&nbsp;</p>
  <p>
    <input type="submit" name="CERRRAR VIGENCIA" id="CERRRAR VIGENCIA" value="CERRAR VIGENCIA" />
  </p>
  <p>&nbsp;</p>
</form>
