...
$fecha=$_GET['fecha'];
$fecha2=$_GET['fecha2'];
$query_total = "SELECT   SUM(`facturas`.`total_fact`)as total, pos.id_caja,pos.nomb_caja,facturas.id_fact,   facturas.fecha_fact FROM   facturas INNER JOIN pos ON (facturas.id_caja = pos.id_caja) WHERE   facturas.activo = 2 and facturas.fecha_fact BETWEEN '$fecha 00:00:00' AND '$fecha 23:59:00' GROUP by `pos`.`id_caja`";
...
WHERE
  facturas.activo = 0  and facturas.fecha_fact BETWEEN '$fecha 00:00:00' AND '$fecha2 23:00:00'";
