...
<p>&nbsp;</p>
<p><br />
  Reporte de articulos eliminados
  <br />
  <br />
</p>
<form action="reporte_prod_eliminados.php" method="get">
  <table width="481" border="0" class="tabla">
    <tr>
      ...
      <td width="55" align="right">Hasta</td>
      <td width="157" align="left"><span id="sprytextfield2">
        <label for="fecha2"></label>
        <input type="text" name="fecha2" id="cal-field-3" />
         <script type="text/javascript">
            Calendar.setup({
